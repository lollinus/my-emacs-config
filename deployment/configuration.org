...
3. pull latest changes
   ...
   #+begin_example
   Updating 3c06c37a8b..e488601849
   Fast-forward
...
make -C src VCSWITNESS='$(srcdir)/../.git/logs/HEAD' BIN_DESTDIR=''/usr/local/bin/'' \
	 ELN_DESTDIR='/usr/local/lib/emacs/28.0.91/' all
...
make -C src VCSWITNESS='$(srcdir)/../.git/logs/HEAD' BIN_DESTDIR=''/home/barskik/emacs-install/bin/'' \
	 ELN_DESTDIR='/home/barskik/emacs-install/lib/emacs/28.0.91/' all
make[1]: Entering directory '/home/barskik/projects/emacs-build/src'
make -C ../lwlib/ liblw.a
make[2]: Entering directory '/home/barskik/projects/emacs-build/lwlib'
make[2]: 'liblw.a' is up to date.
...
set "/home/barskik/emacs-install/share/emacs/28.0.91/etc" "/home/barskik/emacs-install/share/emacs/28.0.91/lisp" ; \
unset CDPATH; \
...
Copying ../emacs/etc to /home/barskik/emacs-install/share/emacs/28.0.91/etc...
./
./NEWS.18
./NEWS
./NEWS.21
...
./schema/schemas.xml
./NEWS.1-17
Copying ../emacs/lisp to /home/barskik/emacs-install/share/emacs/28.0.91/lisp...
./
./cus-dep.el
./xdg.elc
./t-mouse.elc
...
./ps-samp.elc
./tooltip.el
rm -f "/home/barskik/emacs-install/share/emacs/28.0.91/lisp/subdirs.el"
umask 022; ../emacs/build-aux/update-subdirs "/home/barskik/emacs-install/share/emacs/28.0.91/lisp"
subdir="/home/barskik/emacs-install/share/emacs/28.0.91/site-lisp" ; \
...
[ -z "/bin/gzip" ] || { \
  ...
  cd "/home/barskik/emacs-install/share/emacs/28.0.91/lisp" && \
...
Compressing *.el etc. ...
chmod -R a+r "/home/barskik/emacs-install/share/emacs/28.0.91" "/home/barskik/emacs-install/share/emacs/28.0.91/etc" "/home/barskik/emacs-install/share/emacs/28.0.91/lisp"
unset CDPATH; \
umask 022; /bin/mkdir -p "/home/barskik/emacs-install/share/emacs/28.0.91/etc" ; \
exp_etcdocdir=`cd "/home/barskik/emacs-install/share/emacs/28.0.91/etc"; /bin/pwd`; \
if [ "`cd ./etc; /bin/pwd`" != "$exp_etcdocdir" ]; \
then \
   docfile="DOC"; \
   printf 'Copying %s to %s ...\n' "etc/$docfile" \
     "/home/barskik/emacs-install/share/emacs/28.0.91/etc"; \
   /usr/bin/install -c -m 644 etc/${docfile} "/home/barskik/emacs-install/share/emacs/28.0.91/etc/${docfile}"; \
   for installuser in ${LOGNAME} ${USERNAME} ${USER} `(id -u) 2> /dev/null`; do [ -n "${installuser}" ] && break ; done; installgroup=`(id -g) 2>/dev/null` && [ -n "$installgroup" ] && installuser=$installuser:$installgroup; \
     chown ${installuser} "/home/barskik/emacs-install/share/emacs/28.0.91/etc/${docfile}" || true ; \
else true; fi
Copying etc/DOC to /home/barskik/emacs-install/share/emacs/28.0.91/etc ...
umask 022; /bin/mkdir -p "/home/barskik/emacs-install/bin"
make -C lib-src install
make[1]: Entering directory '/home/barskik/projects/emacs-build/lib-src'

Installing utilities run internally by Emacs.
umask 022 && /bin/mkdir -p "/home/barskik/emacs-install/libexec/emacs/28.0.91/x86_64-pc-linux-gnu"
exp_archlibdir=`cd "/home/barskik/emacs-install/libexec/emacs/28.0.91/x86_64-pc-linux-gnu" && /bin/pwd` && \
if [ "$exp_archlibdir" != "`/bin/pwd`" ]; then \
  for file in hexl   ; do \
    /usr/bin/install -c  $file \
      "/home/barskik/emacs-install/libexec/emacs/28.0.91/x86_64-pc-linux-gnu/$file" || exit; \
  done ; \
        fi
exp_archlibdir=`cd "/home/barskik/emacs-install/libexec/emacs/28.0.91/x86_64-pc-linux-gnu" && /bin/pwd` && \
...
make[1]: Leaving directory '/home/barskik/projects/emacs-build/lib-src'
/usr/bin/install -c  src/emacs "/home/barskik/emacs-install/bin/`echo emacs-28.0.91 | sed 's,x,x,'`"
/usr/bin/install -c -m 644 src/emacs.pdmp "/home/barskik/emacs-install/libexec/emacs/28.0.91/x86_64-pc-linux-gnu"/emacs.pdmp
chmod 755 "/home/barskik/emacs-install/bin/`echo emacs-28.0.91 | sed 's,x,x,'`"
rm -f "/home/barskik/emacs-install/bin/`echo emacs | sed 's,x,x,'`"
cd "/home/barskik/emacs-install/bin" && ln -s "`echo emacs-28.0.91 | sed 's,x,x,'`" "`echo emacs | sed 's,x,x,'`"
make -C lib-src maybe-blessmail
make[1]: Entering directory '/home/barskik/projects/emacs-build/lib-src'
make[1]: Nothing to be done for 'maybe-blessmail'.
make[1]: Leaving directory '/home/barskik/projects/emacs-build/lib-src'
umask 022 ; \
find native-lisp -type d -exec /bin/mkdir -p "/home/barskik/emacs-install/lib/emacs/28.0.91/{}" \; ; \
find native-lisp -type f -exec /usr/bin/install -c -m 644 "{}" "/home/barskik/emacs-install/lib/emacs/28.0.91/{}" \;
#+end_example
...
: -rw-rw-r-- 1 barskik barskik 256K Jan 11 14:56 /home/barskik/emacs-remove-8db5f82d45-nlc.sh
