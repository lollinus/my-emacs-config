...
#+begin_src sh :dir ~/projects/emacs-build :results scalar verbatim :var CC='clang'
  echo $CC
#+end_src
...
#+begin_src sh :dir ~/projects/emacs-build :exports code
...
[[file:../../emacs-28-307d164c9c-package.txt]]
...
#+RESULTS:
[[file:../../emacs-28-307d164c9c.remove.sh]]


*** install

#+begin_src sh :dir (concat "/sudo:root@localhost:" (expand-file-name "~/")) :var REV=emacs-rev :exports code
  tar xJvf ~/emacs-28-$REV.tar.xz
#+end_src
