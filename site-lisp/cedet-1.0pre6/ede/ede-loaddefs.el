...
If ARG is negative, disable.  Toggle otherwise." t nil)
...
Return a description suitable for the minibuffer about THIS." nil nil)
...
Optional ROOTRETURN will return the root project for DIR." nil nil)
...
Return a full file name to the project file stored in DIR." nil nil)

(autoload (quote ede-cpp-root-project-root) "ede-cpp-root" "\
Get the root directory for DIR." nil nil)

(autoload (quote ede-cpp-root-load) "ede-cpp-root" "\
Return a CPP root object if you created one.
Return nil if there isn't one.
Argument DIR is the directory it is created for.
ROOTPROJ is nil, since there is only one project." nil nil)
...
based on `ede-locate-setup-options'." t nil)
...
Return nil if there isn't one.
ROOTPROJ is nil, since we will only create a single EDE project here." nil nil)
...
Update various paths to get SRecode to identify our macros." nil nil)
...
Note: Just like `srecode-insert', but templates found in 'ede app." nil nil)
