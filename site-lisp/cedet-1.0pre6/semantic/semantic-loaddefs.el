...
Call `data-debug-insert-tag-parts' based on text properties at POINT." nil nil)
...
Add text properties needed to allow tag expansion later." nil nil)

(autoload (quote data-debug-insert-tag-list) "semantic-adebug" "\
Insert the tag list TAGLIST with PREFIX.
Optional argument PARENT specifies the part of TAGLIST." nil nil)
...
PARENT is the tag that represents the parent of all the tags." nil nil)

(autoload (quote data-debug-insert-find-results) "semantic-adebug" "\
Insert the find results FINDRES with PREFIX." nil nil)

(autoload (quote data-debug-insert-find-results-button) "semantic-adebug" "\
Insert a single summary of a find results FINDRES.
PREFIX is the text that preceeds the button.
PREBUTTONTEXT is some text between prefix and the find results button." nil nil)
...
Optional argument CTXT is the context to show." t nil)
...
Report debug info for checking STARTFILE for up-to-date tags." t nil)
...
Return the tags in TAGS that are of classes in CLASSLIST." nil nil)
...
Debug semantic analysis at the current point." t nil)
...
Use `semantic-analyze-current-tag' to debug this fcn." nil nil)
...
TAGTABLE is passed to `semantic-something-to-tag-table'." t nil)
...
`semantic-something-to-tag-table'." t nil)

(autoload (quote semantic-chart-analyzer) "semantic-chart" "\
Chart the extent of the context analysis." t nil)
...
Non-nil if inline completion is active." nil nil)
...
Optional argument FACE specifies the face to do the highlighting." nil nil)
...
Flush functions from `semantic-decorate-pending-decoration-hooks'." nil nil)
...
keep semantic data structures up to date." nil (quote macro))
...
Changes made by this function are not persistent." t nil)
...
macro `defcustom-mode-local-semantic-dependency-system-include-path'." t nil)
...
Set up a buffer for Semantic parsing for SH language using CTags." nil nil)
...
Any mode that has been tested to work will be added to this function." t nil)
...
Convert the output tags into Semantic tags." t nil)
...
Run the analyzer, using ELP to measure performance." t nil)

(autoload (quote semantic-elp-load-old-run) "semantic-elp" "\
Load an old run from FILE, and show it." t nil)
...
This parameter hasn't be active for a while and is obsolete." nil nil)
...
Optional argument GCC-CMD is an optional command to use instead of \"gcc\"." t nil)
...
origin of the code at point." t nil)
...
parts of the parent classes are displayed." t nil)
...
The VALUE is a spp lexical table." nil nil)

(autoload (quote semantic-lex-spp-write-utest) "semantic-lex-spp" "\
Unit test using the test spp file to test the slot write fcn." t nil)
...
Get the current cached scope, and reset it." nil nil)
...
Stores the SCOPETAGS as a set of tag properties on the cloned tag." nil nil)
...
typecaching system, see `semanticdb-typecache-merge-streams'." nil nil)
...
to perform the search.  This was added for use by a test harness." t nil)
...
Refers to `semantic-symref-tool', to determine the reference tool to use
for the current buffer.
Returns an object of class `semantic-symref-result'." t nil)
...
RESULTS is an object of class `semantic-symref-results'." t nil)
...
PARENT can also be a `semanticdb-table' object." nil nil)
...
something without an implementation." nil nil)
...
If optional DONTADDNEWLINE is non-nil, then don't add a newline." nil nil)

(autoload (quote semantic-tag-write-list-slot-value) "semantic-tag-write" "\
Write out the VALUE of a slot for EIEIO.
The VALUE is a list of tags." nil nil)
...
(autoload (quote semantic-utest-main) "semantic-utest" nil t nil)
...
Run parsing test for C from the test directory." t nil)
...
(custom-add-to-group (quote semantic) (quote global-semantic-highlight-func-mode) (quote custom-variable))

(custom-add-load (quote global-semantic-highlight-func-mode) (quote semantic-util-modes))
...
Dump a list of all databases in Emacs memory." t nil)
...
Run ADEBUG on the current database." t nil)
...
Validate that CACHE tags do not have any overlays in them." nil nil)

(autoload (quote semanticdb-table-sanity-check) "semanticdb-debug" "\
Validate the current semanticdb TABLE." t nil)

(autoload (quote semanticdb-database-sanity-check) "semanticdb-debug" "\
Validate the current semantic database." t nil)
...
is specified by `semanticdb-default-save-directory'." t nil)
...
version needed by Semantic ctags support." t nil)
...
TABLE is optional if INCLUDETAG has an overlay of :filename attribute." nil nil)
...
in a GNU Global supported hierarchy." t nil)
...
will be added to the database that INCLUDE-TAG refers to." nil nil)
...
Merge into CACHE1 and CACHE2 together.  The Caches will be merged in place." nil nil)
...
FIND-FILE-MATCH is non-nil to force all found tags to be loaded into a buffer." nil nil)

(autoload (quote semanticdb-typecache-refresh-for-buffer) "semanticdb-typecache" "\
Refresh the typecache for BUFFER." nil nil)

(autoload (quote semanticdb-typecache-dump) "semanticdb-typecache" "\
Dump the typecache for the current buffer." t nil)

(autoload (quote semanticdb-db-typecache-dump) "semanticdb-typecache" "\
Dump the typecache for the current buffer's database." t nil)
